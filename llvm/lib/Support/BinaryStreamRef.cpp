...
public:
  ...
  size_t getLength() override { return BBS.getLength(); }
...
public:
  ...
  Error writeBytes(size_t Offset, ArrayRef<uint8_t> Data) override {
...
BinaryStreamRef::BinaryStreamRef(BinaryStream &Stream, size_t Offset,
...
Error BinaryStreamRef::readBytes(size_t Offset, size_t Size,
...
Error BinaryStreamRef::readLongestContiguousChunk(
    size_t Offset, ArrayRef<uint8_t> &Buffer) const {
  ...
  size_t MaxLength = getLength() - Offset;
...
Error WritableBinaryStreamRef::writeBytes(size_t Offset,
