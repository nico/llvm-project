...
private:
  ...
  void fixCacheAfterWrite(size_t Offset, ArrayRef<uint8_t> Data) const;

  Error readBytes(size_t Offset, MutableArrayRef<uint8_t> Buffer);
  bool tryReadContiguously(size_t Offset, size_t Size,
